...
package org.apache.spark.sql.execution.mbt.exec.search

import org.apache.spark.internal.Logging
import org.apache.spark.rdd.RDD
import org.apache.spark.sql.catalyst.InternalRow
import org.apache.spark.sql.catalyst.expressions.mbt.MBTSimilarityFunction
import org.apache.spark.sql.catalyst.expressions.mbt.common.metric.{MBTSimilarity, MetricData}
import org.apache.spark.sql.catalyst.expressions.mbt.common.shape.{Point, Shape}
import org.apache.spark.sql.catalyst.expressions.{Attribute, Expression}
import org.apache.spark.sql.catalyst.plans.logical.LogicalPlan
import org.apache.spark.sql.execution.mbt.algorithms.MetricRangeAlgorithms
import org.apache.spark.sql.execution.mbt.exec.MetricExecUtils
import org.apache.spark.sql.execution.mbt.sql.MBTIternalRow
import org.apache.spark.sql.execution.{SparkPlan, UnaryExecNode}

case class MBTRangeSearchExec(function: MBTSimilarityFunction,
                              leftQuery: Point[Any], rightKey: Expression,
                              threshold: Double,
  ...
  protected override def doExecute(): RDD[InternalRow] = {
    ...
    val rightMBTRDD = MetricExecUtils.getMBTRDD(function, sqlContext, rightResults,
    ...
    val answerRDD = search.search(sparkContext, leftQuery, rightMBTRDD, threshold)
    end = System.currentTimeMillis()
    logWarning(s"MBT Range Search Time: ${end - start} ms")
    val outputRDD = answerRDD.map(x => x._1.asInstanceOf[MBTIternalRow].row)
