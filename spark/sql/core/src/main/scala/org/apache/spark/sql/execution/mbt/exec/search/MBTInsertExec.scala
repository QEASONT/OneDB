...
import org.apache.spark.sql.execution.mbt.algorithms.MetricInsertAlgorithms
...
case class MBTInsertExec(function: MBTSimilarityFunction, leftQuery: Point[Any], rightKey: Expression,
  ...
  protected override def doExecute(): RDD[InternalRow] = {
    ...
    // get answer
    val search = MetricInsertAlgorithms.DistributedSearch
    val answerRDD = search.search(sparkContext, leftQuery, rightMBTRDD)
    end = System.currentTimeMillis()
    logWarning(s"MBT Insert Time: ${end - start} ms")
