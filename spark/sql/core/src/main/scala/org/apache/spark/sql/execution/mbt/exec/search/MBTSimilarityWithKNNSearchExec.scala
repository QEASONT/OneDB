...
import org.apache.spark.sql.catalyst.expressions.mbt.common.metric.{MetricData, MBTSimilarity}
...
import org.apache.spark.sql.execution.mbt.algorithms.MetricSimilarityWithKNNAlgorithms
...
case class MBTSimilarityWithKNNSearchExec(leftQuery: Point[Any], rightKey: Expression,
  ...
  protected override def doExecute(): RDD[InternalRow] = {
    val distanceFunction = MBTSimilarity.getDistanceFunction(function)
    ...
    val rightMchordRDD = MetricExecUtils.getMBTRDD(function, sqlContext, rightResults,
    ...
    logWarning(s"MBT kNN Search Time: ${end - start} ms")
