...
import org.apache.spark.sql.execution.odb.algorithms.MetricInsertAlgorithms
...
case class ODBInsertExec(leftQuery: MetricData, rightKey: Expression,
  ...
  protected override def doExecute(): RDD[InternalRow] = {
    ...
    val answerRDD = search.search(sparkContext, leftQuery, rightODBRDD)
    end = System.currentTimeMillis()
    logWarning(s"ODB Insert Time: ${end - start} ms")
