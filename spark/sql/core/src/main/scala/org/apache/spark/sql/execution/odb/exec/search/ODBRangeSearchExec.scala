...
import org.apache.spark.sql.catalyst.expressions.odb.common.metric.{ODBSimilarity, MetricData}
import org.apache.spark.sql.catalyst.expressions.odb.common.shape.{Point, Shape}
import org.apache.spark.sql.catalyst.expressions.{Attribute, Expression}
import org.apache.spark.sql.catalyst.plans.logical.LogicalPlan
import org.apache.spark.sql.execution.odb.algorithms.MetricRangeAlgorithms
...
case class ODBRangeSearchExec(leftQuery: MetricData, rightKey: Expression,
                              threshold: Double, queryM: Array[Int],
