...
import org.apache.spark.sql.execution.mchord.algorithms.MetricSimilarityWithKNNAlgorithms
...
case class MetricSimilarityWithKNNSearchExec(leftQuery: Point[Any], rightKey: Expression,
  ...
  protected override def doExecute(): RDD[InternalRow] = {
    val distanceFunction = MetricSimilarity.getDistanceFunction(function)
    ...
    logWarning(s"M-Chord kNN Search Time: ${end - start} ms")
