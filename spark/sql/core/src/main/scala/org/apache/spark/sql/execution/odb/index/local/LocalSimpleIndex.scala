...
import org.apache.spark.sql.execution.odb.partition.local.LocalSimplePartitioner
...
object LocalSimpleIndex {
  def buildIndex(dataKeyValuePair: Array[(Double, Point[Any])]): LocalSimpleIndex = {
