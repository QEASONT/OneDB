...
import org.apache.spark.sql.execution.mbt.algorithms.MetricDeleteAlgorithms
...
case class MBTDeleteExec(function: MBTSimilarityFunction, leftQuery: Point[Any], rightKey: Expression,
  ...
  protected override def doExecute(): RDD[InternalRow] = {
    ...
    logWarning(s"MBT Delete Time: ${end - start} ms")
