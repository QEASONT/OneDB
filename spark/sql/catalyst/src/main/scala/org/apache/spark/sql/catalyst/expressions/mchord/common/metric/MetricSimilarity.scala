...
package org.apache.spark.sql.catalyst.expressions.mchord.common.metric
...
trait MetricSimilarity extends Serializable {
...
object MetricSimilarity {
  def getDistanceFunction(function: MetricSimilarityFunction):
  MetricSimilarity = function match {
    case MetricSimilarityFunction.EUCLID => MetricSimilarity.EUCLIDistance

  }

  object EUCLIDistance extends MetricSimilarity {
    private final val MAX_COST = Array.fill[Double](1, 1)(MchordConfigConstants.THRESHOLD_LIMIT)
